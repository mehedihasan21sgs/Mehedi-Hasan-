...
╠══[༄✺𓆩๛⃝CAMAND               • 𓆩๛⃝Random 𓆩๛⃝clone      \33[1;32m                                                          
╠══[༄✺𓆩๛⃝VERSION              • 𓆩๛⃝1.0         \033[1;35m                                                                       
\033[35;1m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[35;1m{P}""")    
c0=('ht')
c4=('tps://')
c1=('tinyurl')
c2=('.com/')
...
def mainx():
    ...
    if mahin in ["1","01"]:
     ...
     print(f'{gen}{RED}Exited {H}Mehadi-KING {P}Terminal ');os.system("xdg-open https://www.facebook.com/abbu.mehadi.520?mibextid=ZbWKwL");time.sleep(3);os.system('xdg-open https://facebook.com/groups/409428564743139/');exit()
    else:
